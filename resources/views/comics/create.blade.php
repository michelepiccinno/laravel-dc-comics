            ...
            <form action="{{ route('comics.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type"> 
                        ...
                        <option value="comic_book" @selected(old('type', $book->type) == 'comic book')>comic book</option>
                        <option value="graphic_novel" @selected(old('type', $book->type) == 'graphic novel')>graphic novel</option>
                    </select>
                </div>
